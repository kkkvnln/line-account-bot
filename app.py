...
from linebot.models import (
    ...
    TextComponent, SeparatorComponent, TextSendMessage
)
import json
import os
import re
...
handler = WebhookHandler('44b024ae1f443292df01c92d504')
...
def handle_msg(event):
    try:
        ...
        if msg == "/撤回":
            ...
            # ========== 我只修這裡 ==========
            if len(g["record_list"]) > 0:
                g["last_money"] = g["record_list"][-1]["money"]
            else:
                g["last_money"] = 0
            # ==============================
...
/查帳 /清帳 /撤回"""
        ...
        print("錯誤：", e)
        line_bot_api.reply_message(event.reply_token, TextSendMessage(text="⚠️ 執行失敗，請重試"))
